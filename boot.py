...
def get_internal_logger():
    ...
    try:
        from application.logging import LoggerProfile, get_logger, get_log_level, reset as reset_logger
...
def load_env(env='dev', force=False, debug=False):
    ...
    if not _LOADED or force:
        ...
        if os.path.isfile(chalice_config_path):
            ...
            if debug:
                logger.info('Boot - load_env - Application compatibility')
