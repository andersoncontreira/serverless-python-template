...
def add_handler_by_profile(logger: logging.Logger, profile=None, **kwargs):
    ...
    try:
        ...
        if profile == LoggerProfile.ELK:
            from application.logging_resources.elk_resource import add_elk_handler
            add_elk_handler(logger, **kwargs)

        elif profile == LoggerProfile.NEWRELIC:
            from application.logging_resources.newrelic_resource import add_newrelic_handler
            # new relic attrib
