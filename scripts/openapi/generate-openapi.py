...
def register_paths():
    ...
    if not _REGISTERED_PATHS:
        ...
        sys.path.insert(1, ROOT_DIR + 'application/')
...
def load_env():
    ...
    from application.helper import get_environment
    load_env(get_environment())


def openapi():
    from application.openapi import generate_openapi_yml
    from app import spec
    from application.logging import get_console_logger
