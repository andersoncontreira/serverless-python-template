"""
Boot Unit Test for Application
Version: 1.0.0
"""
import os
import unittest
...
from tests.unit.mocks.application_mocks.aws.secrets_mock import secrets_mock_caller
...
class BootTestCase(BaseUnitTestCase):
    ...
    @patch('application.aws.secrets.Secrets', secrets_mock_caller)
