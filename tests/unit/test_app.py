...
from tests.unit.mocks.application_mocks.services.healthcheck_manager_mock import health_check_manager_caller
from tests.unit.mocks.application_mocks.services.v1.healthcheck.resources_mock import \
...
class AppTestCase(BaseUnitTestCase):
    ...
    @patch.multiple('application.services.healthcheck_manager',
